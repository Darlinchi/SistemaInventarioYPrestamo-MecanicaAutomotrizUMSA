...
use Maatwebsite\Excel\Concerns\WithValidation;      // ← NUEVO

class TeacherImport implements SkipsOnError, ToModel, WithChunkReading, WithHeadingRow, WithMapping, WithValidation
{
    use SkipsErrors;
