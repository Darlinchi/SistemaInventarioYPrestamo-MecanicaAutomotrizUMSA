 ...
 * @route '/dashboard/tools/{tool}'
 */
const updatec511625d29238eeb2c7d46166f79bf7e = (args: { tool: number | { id: number } } | [tool: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updatec511625d29238eeb2c7d46166f79bf7e.url(args, options),
    method: 'put',
})

updatec511625d29238eeb2c7d46166f79bf7e.definition = {
    methods: ["put"],
    url: '/dashboard/tools/{tool}',
 ...
 * @route '/dashboard/tools/{tool}'
 */
updatec511625d29238eeb2c7d46166f79bf7e.url = (args: { tool: number | { id: number } } | [tool: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { tool: args }
    }
    ...
    return updatec511625d29238eeb2c7d46166f79bf7e.definition.url
            .replace('{tool}', parsedArgs.tool.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/dashboard/tools/{tool}'
 */
updatec511625d29238eeb2c7d46166f79bf7e.put = (args: { tool: number | { id: number } } | [tool: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updatec511625d29238eeb2c7d46166f79bf7e.url(args, options),
    method: 'put',
})
 ...
 * @route '/dashboard/tools/{tool}'
 */
updatec511625d29238eeb2c7d46166f79bf7e.patch = (args: { tool: number | { id: number } } | [tool: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updatec511625d29238eeb2c7d46166f79bf7e.url(args, options),
    method: 'patch',
})
