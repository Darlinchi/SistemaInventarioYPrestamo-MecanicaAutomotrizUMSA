 ...
 * @route '/dashboard/equipments/{equipment}'
 */
    const updatef02380ce70cc8e8dc1e73fc707552ed2Form = (args: { equipment: number | { id: number } } | [equipment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: updatef02380ce70cc8e8dc1e73fc707552ed2.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PUT',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/dashboard/equipments/{equipment}'
 */
        updatef02380ce70cc8e8dc1e73fc707552ed2Form.put = (args: { equipment: number | { id: number } } | [equipment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updatef02380ce70cc8e8dc1e73fc707552ed2.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    updatef02380ce70cc8e8dc1e73fc707552ed2.form = updatef02380ce70cc8e8dc1e73fc707552ed2Form
    /**
* @see \App\Http\Controllers\EquipmentController::update
 * @see app/Http/Controllers/EquipmentController.php:182
 * @route '/dashboard/equipments/{equipment}'
 ...
 * @route '/dashboard/equipments/{equipment}'
 */
        updatef02380ce70cc8e8dc1e73fc707552ed2Form.patch = (args: { equipment: number | { id: number } } | [equipment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updatef02380ce70cc8e8dc1e73fc707552ed2.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
