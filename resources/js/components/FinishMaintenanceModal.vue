...
import {
    XIcon, ClipboardPen, Cog, Building2, CalendarClock, CalendarCheck2, ClockAlert,
    Calendar, Clock, Package, Wrench, AlignLeft, Loader2
        ...
        <div class="bg-white w-full max-w-3xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in duration-300">
            ...
            <div class="p-8 pt-2 overflow-y-auto custom-scrollbar space-y-6 flex-1 bg-neutral-50/30">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 p-6 bg-neutral-50 rounded-3xl border border-neutral-200 shadow-sm">
                    <div class="space-y-1">
                        ...
                        <span class="inline-block px-2 py-0.5 rounded-md bg-[#1a3a5a]/10 text-[13px] font-black text-[#1a3a5a]">
                            Código QR: {{ maint?.equipment.codigo_qr }}
                        </span>
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 bg-neutral-50 rounded-2xl border border-neutral-200 mt-4">
                        ...
                        <div class="flex flex-col gap-3 border-l border-neutral-100 pl-4">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="p-2 bg-white rounded-lg shadow-sm">
                                    <ClockAlert class="w-4 h-4 text-green-600" />
                                </div>
                                <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <Label class="text-[13px] font-black uppercase text-neutral-800 tracking-widest flex items-center gap-2 px-2">
                            <Package class="w-3.5 h-3.5" /> Estado tras revisión
                        </Label>
                        <select v-model="form.estado_equipo"
                            class="w-full text-sm font-bold rounded-2xl border-neutral-200 bg-white focus:ring-4 focus:ring-[#1a3a5a]/5 transition-all py-3 px-4 outline-none border-2 focus:border-[#1a3a5a]">
                    ...
                    <div class="space-y-2">
                        <Label class="text-[13px] font-black uppercase text-neutral-800 tracking-widest flex items-center gap-2 px-2">
                            <Wrench class="w-3.5 h-3.5" /> Tipo de Trabajo
                        </Label>
                        <div class="py-3 px-5 bg-neutral-100 rounded-2xl border border-neutral-200 text-sm font-bold text-neutral-600">
