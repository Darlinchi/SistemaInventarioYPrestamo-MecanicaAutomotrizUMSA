...
import { Plus, FileClock, ClipboardPen, ArrowLeft, Wrench, Building2, Loader2, Save, Package } from 'lucide-vue-next';
...
// Filtrar los equipos que vienen desde el controlador
const filteredItems = computed(() => {
    // Si tus datos vienen como unit.item.nombre_item (por el Eager Loading)
    return props.equipment.filter(unit =>
        unit.item.nombre_item.toLowerCase().includes(searchTerm.value.toLowerCase()) ||
        unit.serie.toLowerCase().includes(searchTerm.value.toLowerCase())
    );
});
                ...
                <div class="md:col-span-2 space-y-6">
                    <div class="bg-white p-6 rounded-xl border border-neutral-200 shadow-sm flex-1">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <span v-if="form.equipment_id" class="text-xs font-bold bg-green-100 text-green-600 px-3 py-1 rounded-full">
                        ...
                        <div class="relative mb-4">
                            ...
                            <input v-model="searchTerm" type="text" placeholder="Buscar por nombre o número de serie..."
                    ...
                    <Button type="submit"
                            class="w-full py-8 text-xl font-black uppercase tracking-tighter shadow-lg shadow-blue-100"
                            :disabled="form.processing || !form.equipment_id">
